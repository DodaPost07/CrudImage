            ...
            <div class="col-lg-12 margin-tb">
                <div>
                    ...
                    <form action="{{  route('web.index')  }}" method="GET" class="form-inline mt-2 mt-md-0">
                        ...
                        <button class="btn btn-success fa fa-search my-2 my-sm-0" type="submit">Search</button>
                    </form>
                </div>
            ...
            <tr>
                ...
                <td>
                    <form action="{{ route('posts.destroy',$post->id) }}" method="POST">
                        ...
                        <a class="btn btn-warning fa fa-edit" href="{{ route('posts.edit',$post->id) }}">Modifier</a>

                        <a class="btn btn-info fa fa-info-circle" href="{{ route('posts.show',$post->id) }}">Montrer</a>
                        ...
                        <button type="submit" class="btn btn-danger fa fa-trash">Effacer</button>
                    </form>
                </td>
            </tr>
            @endforeach
